    ...
    projects = [
        {
            "title": "Ola App Clone",
            "category": "DSA",
            "description": "A clone of the Ola app focusing on data structures and algorithms.",
            "timeline": "2025",
            "icon": "https://img.icons8.com/clouds/500/car.png",
            "highlighted": True
        },
        {
            "title": "Portfolio using Flask",
            "category": "Python",
            "description": "This personal portfolio website built using Flask.",
            "timeline": "2025",
            "icon": "static/assets/portfolio-screenshot.png",  # Use your screenshot image path
            "highlighted": True
        },
        {
            "title": "QR Code Generator",
            "category": "Python",
            "description": "A simple QR code generator built with Python.",
            "timeline": "2025",
            "icon": "https://img.icons8.com/clouds/500/qr-code.png",
            "highlighted": False
        },
        {
            "title": "Food Order Management System",
            "category": "Python/Flask",
            "description": "A simple food ordering system where users can select meals, place orders, and view delivery status.",
            "timeline": "2025",
            "icon": "https://img.icons8.com/clouds/500/restaurant.png",
            "highlighted": False
        },
        {
            "title": "Calendar App",
            "category": "Python/Flask",
            "description": "A lightweight and responsive calendar app to organize schedules, set reminders, and track deadlines.",
            "timeline": "2025",
            "icon": "https://img.icons8.com/clouds/500/calendar.png",
            "highlighted": False
        }
    ]
    return render_template('projects.html', title="Projects", cards=projects)
